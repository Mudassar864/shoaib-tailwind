  ...
  fields: [
    ...
    },
    {
      ...
      options: {
        ...
        slugify: (input) =>
          input.toLowerCase().replace(/\s+/g, "-").slice(0, 200), // Slug generation function
      },
    },
    {
      name: "price",
    ...
    },
    {
      ...
      of: [{ type: "string" }],
      description:
        "Category of the off-plan project (e.g., residential, commercial, etc.)",
    },
    {
      name: "lifestyle",
      title: "Lifestyle",
    ...
    },
    {
      ...
      type: "array",
      of: [{ type: "string" }],
      description: "Features of the off-plan project (e.g., pools, gym, etc.)",
    },
    {
      name: "handover",
      title: "Handover",
